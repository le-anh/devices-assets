            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a class="mb-xs mt-xs mr-xs modal-with-zoom-anim btn btn-primary" href="#modalDeliveryConfirm" onclick="Delivered('{{ $order ?? [] }}', '{{ json_encode($arrDetail)}}'); return false;"> <i class="fa fa-truck"></i> </a>
                        ...
                        <a class="mb-xs mt-xs mr-xs modal-with-zoom-anim btn btn-warning" href="#modalEdit" onclick="Edit('{{ $order ?? [] }}', '{{ json_encode($arrDetail)}}'); return false;"> <i class="fa fa-pencil"></i> </a>
                        <a class="mb-xs mt-xs mr-xs modal-with-zoom-anim btn btn-danger" href="#modalDelete" onclick="Delete('{{ $order->id ?? [] }}'); return false;"> <i class="fa fa-trash-o"></i> </a>
                    </td>
                </tr>
                @endforeach
            </tbody>
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea rows="5" id="note" name="note" class="form-control" placeholder="Type your note..." autofocus></textarea>
                    </div>
                </div>
                <div class="form-group">
...
<script>
    ...
    ClassicEditor
        .create( document.querySelector('#note_delivered'))
        .then( newEditor => {
            editorNote_delivered = newEditor;
        })
        .catch( error => {
            console.error( error );
        });
    ...
    function Edit(order, orderdetail) {
        ...
        editorNote_edit.setData(order.note ?? '');
        $.each(orderdetail, function(index, value) {
    ...
    function Delivered(order, orderdetail) {
        ...
        editorNote_delivered.setData(order.note);
        $.each(orderdetail, function(index, value) {
